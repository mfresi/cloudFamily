...
<body>
    ...
    <!-- Hero Section Begin -->
    <!-- TODO prendre les images de la bdd et les infos supp -->
    <section class="hero">
        <div class="container">
            <div class="hero__slider owl-carousel">
                <div class="hero__items set-bg" data-setbg="img/hero/img1.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">Vacances foret</div>
                ...
                <div class="hero__items set-bg" data-setbg="img/hero/img2.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">Vacances Montagnes</div>
                                <h2>Fate / Stay Night: Unlimited Blade Works</h2>
                                <p>After 30 days of travel across the world...</p>
                                <a href="#"><span>Watch Now</span></a>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="footer__nav">
                    <ul>
                        ...
                        <li><a href="./blog.html">Ma page</a></li>
            ...
            <div class="col-lg-3">
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Mattei Fresi</a>
